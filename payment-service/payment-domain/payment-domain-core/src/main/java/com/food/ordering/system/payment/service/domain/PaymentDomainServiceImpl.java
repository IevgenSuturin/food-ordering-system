...
public class PaymentDomainServiceImpl implements PaymentDomainService{
    ...
    @Override
    public PaymentEvent validateAndCanselPayment(Payment payment,
                                                 CreditEntry creditEntry,
                                                 List<CreditHistory> creditHistories,
                                                 List<String> failureMessages,
    ...
    private void updateCreditHistory(Payment payment, List<CreditHistory> creditHistories,
        ...
        creditHistories.add(CreditHistory.builder()
                        .creditHistoryId(new CreatedHistoryId(UUID.randomUUID()))
    ...
    private void validateCreditHistory(CreditEntry creditEntry,
        ...
        if (!creditEntry.getTotalCreditAmount().equals(totalDebitHistory.subtract(totalCreditHistory))) {
