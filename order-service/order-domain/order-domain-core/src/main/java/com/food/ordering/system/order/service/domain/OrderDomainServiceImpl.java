...
public class OrderDomainServiceImpl implements OrderDomainService {
    ...
    public OrderCancelledEvent cancelOrderPayment(Order order, List<String> failureMessages,
                                                  DomainEventPublisher<OrderCancelledEvent> orderCreatedEventPublisher) {
    ...
    @Override
    public void canselOrder(Order order, List<String> failureMessages) {
...
//                );
        ...
        order.getItems()
                .forEach(orderItem -> {
                    Product restaurantProduct = restaurantProducts.get(orderItem.getProduct());
